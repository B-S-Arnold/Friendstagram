...
def seed_users():
    ...
    greg = User(
        username='theOneGregHirsch', email='greghirsch@aa.io', password='password', fullName='Greg Hirsch', url='https://static.wikia.nocookie.net/succession/images/0/02/Sporuslol.png/revision/latest?cb=20220425193919')
    peggy = User(
    ...
    bart = User(
        username='elbarto', email='bartman@aa.io', password='password', fullName='El Barto', url='https://w0.peakpx.com/wallpaper/644/931/HD-wallpaper-bart-simpson.jpg')
    carl = User(
